...
library(tidyverse)
data <- read.csv('D:\\Libraries 1\\Documents\\QMSS\\Data For Good\\DataPreprocessingtoMaster\\preprocessfinal12_08_2020.csv')
...
#to put into Notes.Other.Information
Birth.Month 
Years.Married 
...
final_join <- final_join %>% unite(new_var,  Birth.Month,
Years.Married ,	
Number.of.Children.Born,
Number.of.Children.Living,	
Years.in.US,
...
final_join[,(ncol(final_join)-5):ncol(final_join)] # refers to the 4 last columns
#colnames(final_join[,(ncol(final_join)-8):ncol(final_join)])
#corrected, new running total of columns is 100

```

combine REGIMENT and Regt.

into notes
Burial.Place

# old to delete columns
```{r OLD columns to drop}
...
# old 
```{r OLD columns to add into Notes.Other.Information}
...
# to merge together into one column called Notes.Other.Information
Cause.of.Death,
Years.Married,	
Number.of.Children.Born,
Number.of.Children.Living,	
...
#export to csv
write.csv(x=final_join, file="preprocessfinal1_27_2021.csv")
